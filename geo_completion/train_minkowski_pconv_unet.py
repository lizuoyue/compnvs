...
from minkowski_pconv_unet import MinkUNet34C
...
def val_model(
    ...
    real_x = ME.SparseTensor(coordinates=vertex_idx, features=vertex_input[:,:32])
...
if __name__ == '__main__':
    ...
    gen = MinkUNet34C(emb_size, emb_size).to(device)
    ...
    save_path = 'ckpt_minkowski_pconv_unet34c_'
