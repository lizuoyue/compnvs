...
# from examples.minkunet import MinkUNet50
from minkunet import MinkUNet50
...
def val_model(
    ...
    with torch.no_grad():
        fake_y = gen(real_x)
        fake_y += replace_features(real_x, real_x.F[:,:-1])
...
if __name__ == '__main__':
    ...
    save_path = 'ckpt_minkowski_unet50inst_encft'
    train_model(
