...
# just for debugging
DATA="ReplicaSingleAll10cmGlobal/all"
RES="256x256" # hxw
ARCH="gated_scn_nsvf_base"
SUFFIX="v1_fixfield_no_ft_loss"
...
CUDA_VISIBLE_DEVICES=1 python3 train.py ${DATASET} \
    --user-dir fairnr \
    --task single_object_rendering \
    --train-views "zuri_train_0:240" \
    --view-resolution $RES \
    --max-sentences 1 \
    --view-per-batch 1 \
    --pixel-per-view 8192 \
    ...
    --valid-views "zuri_train_240:250" \
