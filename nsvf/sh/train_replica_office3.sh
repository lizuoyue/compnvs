...
CUDA_VISIBLE_DEVICES=9 python3 train.py ${DATASET} \
    --user-dir fairnr \
    ...
    --arch $ARCH \
    --voxel-path ${DATASET}/init_voxel/fine_points_0.2.txt \
    ...
    --num-workers 0 \
    --seed 2 \
    --save-interval-updates 100 --max-update 100000 \
...
# (yy) lzq@ce206-gpu1:~/lzy/NSVF/Replica/office3_init_voxel/tensorboard/nsvf_basev1/images$ 
