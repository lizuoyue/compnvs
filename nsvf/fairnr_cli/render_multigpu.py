...
def _main(args, output_file):
    ...
    # print('max_sentences', args.max_sentences)
    # print('max_positions',
    #     utils.resolve_max_positions(
    #         task.max_positions(), *[model.max_positions() for model in models]
    #     )
    # )
    # print('ignore_invalid_inputs', args.skip_invalid_size_inputs_valid_test)
    # print('required_batch_size_multiple', args.required_batch_size_multiple)
    # print('seed', args.seed)
    # print('num_shards', args.distributed_world_size)
    # print('shard_id', args.distributed_rank)
    ...
    with progress_bar.build_progress_bar(args, itr) as t:
        ...
        for i, sample in enumerate(t):        
            ...
            gen_timer.start()
            # The following line calls the inference of the model
