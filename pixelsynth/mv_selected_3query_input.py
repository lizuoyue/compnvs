...
src_input_dir = '/home/lzq/lzy/replica_habitat_gen/rebuttal_replica_input/rgb'
rgb_dst_dir = 'res_3query_replica_input_sltd/rgb'
gif_dst_dir = 'res_3query_replica_input_sltd/gif'
...
for sltd_3query in tqdm.tqdm(sltd_3queries):
    ...
    for i, view_name in enumerate(view_names):
        view_imgs = [Image.open(f'{src_input_dir}/{s}_{view_name}/{img_idx:02d}.jpg').convert('RGB') for img_idx in range(14)]
        sltd_3query_imgs += view_imgs[::-1] if orders[i] == -1 else view_imgs
