...
if __name__ == '__main__':
    ...
    # source = torch.load(f'ReplicaGenFtTriplets/easy/geo_scn_nsvf_basev1_regdim32out/checkpoint1.pt')
    # target = torch.load(f'ReplicaGenFtTriplets/easy/geo_scn_nsvf_basev1_regdim32out_disc/checkpoint_1_1.pt')
    source = torch.load(f'ReplicaGenFtTriplets/easy/mink_nsvf_basergba_init_v1/checkpoint_last.pt')
    target = torch.load(f'ReplicaGenFtTriplets/easy/mink_nsvf_basergba_init_v1_disc/checkpoint_1_1.pt')
    ...
    # torch.save(target, f'ReplicaGenFtTriplets/easy/geo_scn_nsvf_basev1_regdim32out_disc/checkpoint_last.pt')
    torch.save(target, f'ReplicaGenFtTriplets/easy/mink_nsvf_basergba_init_v1_disc/checkpoint_last.pt')
    quit()
    ...
    encoder = torch.load(f'SparseConvNet/ckpt_lzq_unet_gen_ftio_regdim32emb32out/ckpt_32_0.pt')['model_state_dict']
    ...
    current = torch.load(f'ReplicaGenFtTriplets/easy/geo_scn_nsvf_basev1_regdim32out_disc/checkpoint_last_saved.pt')
    ...
    torch.save(current, f'ReplicaGenFtTriplets/easy/geo_scn_nsvf_basev1_regdim32out_disc/checkpoint_last.pt')
